<template>
  <footer
    class="flex justify-center items-center flex-col h-auto min-h-[70px] p-[15px] text-center"
  >
    <div class="block w-full max-w-[270px] mx-auto mt-0 mb-[10px] md:hidden">
      <ul class="flex justify-between items-center p-0 m-0 list-none">
        <li class="list-item">
          <a
        ...
        <li class="list-item">
          ...
          >
            <svg
              ...
              xmlns="http://www.w3.org/2000/svg"
              viewBox="0 0 50 50"
              class="w-7 h-7 transition duration-150 ease-in hover:fill-[#94ffed]"
            >
              <path
        ...
        <li class="list-item">
          <a
            href="https://www.linkedin.com/in/yad-araz-3b966a262/"
            target="_blank"
            class="p-[10px] inline-block no-underline text-inherit relative cursor-pointer"
          >
            <svg
